...
public class Type3OutsideUseData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6965640056202231598L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Type3OutsideUseData\",\"namespace\":\"cn.cbdc.canconvert.avro.schema.can300\",\"fields\":[{\"name\":\"dateTime\",\"type\":\"string\"},{\"name\":\"label\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"string\"},{\"name\":\"unit\",\"type\":\"string\"}],\"default\":null}");
   ...
   */
  public static cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder newBuilder() {
    return new cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder();
  }
   ...
   * @return A new Type3OutsideUseData RecordBuilder
   */
  public static cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder newBuilder(cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder other) {
    return new cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder(other);
  }
   ...
   * @return A new Type3OutsideUseData RecordBuilder
   */
  public static cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder newBuilder(cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData other) {
    return new cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Type3OutsideUseData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.dateTime)) {
        this.dateTime = data().deepCopy(fields()[0].schema(), other.dateTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder setDateTime(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder clearDateTime() {
      dateTime = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder setValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder setUnit(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Type3OutsideUseData.Builder clearUnit() {
      unit = null;
