...
public class Dcm19Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity e0: this.dataCapacityList) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (this.commonHeader == null) {
        this.commonHeader = new zdf.learn.com.commonUtils.data.avro.schema.can300.CommonHeader();
      }
      this.commonHeader.customDecode(in);

      if (this.updCondition == null) {
        this.updCondition = new zdf.learn.com.commonUtils.data.avro.schema.can300.UpdCondition();
      }
      this.updCondition.customDecode(in);

      if (this.vehicleInformationHeader == null) {
        this.vehicleInformationHeader = new zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader();
      }
      this.vehicleInformationHeader.customDecode(in);

      long size0 = in.readArrayStart();
      java.util.List<zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity> a0 = this.dataCapacityList;
      if (a0 == null) {
        a0 = new SpecificData.Array<zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity>((int)size0, SCHEMA$.getField("dataCapacityList").schema());
        this.dataCapacityList = a0;
      } else a0.clear();
      SpecificData.Array<zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new zdf.learn.com.commonUtils.data.avro.schema.can300.DataCapacity();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
