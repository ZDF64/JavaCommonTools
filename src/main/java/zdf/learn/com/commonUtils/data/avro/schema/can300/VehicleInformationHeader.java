...
public class VehicleInformationHeader extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5633585783234925088L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"VehicleInformationHeader\",\"namespace\":\"src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300\",\"fields\":[{\"name\":\"dataCapacityNumber\",\"type\":[\"null\",\"int\"],\"default\":null},{\"name\":\"timeZoneOffset\",\"type\":[\"null\",\"int\"],\"default\":null}],\"default\":null}");
   ...
   */
  public static src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder newBuilder() {
    return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder();
  }
   ...
   * @return A new VehicleInformationHeader RecordBuilder
   */
  public static src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder newBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder other) {
    if (other == null) {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder();
    } else {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder(other);
    }
  }
   ...
   * @return A new VehicleInformationHeader RecordBuilder
   */
  public static src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder newBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader other) {
    if (other == null) {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder();
    } else {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VehicleInformationHeader>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.dataCapacityNumber)) {
        this.dataCapacityNumber = data().deepCopy(fields()[0].schema(), other.dataCapacityNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder setDataCapacityNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder clearDataCapacityNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder setTimeZoneOffset(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.VehicleInformationHeader.Builder clearTimeZoneOffset() {
      timeZoneOffset = null;
