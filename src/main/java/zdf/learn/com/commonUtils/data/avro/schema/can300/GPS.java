...
public class GPS extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point point;
   ...
   */
  public GPS(java.lang.CharSequence gpsDate, src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point point, java.lang.Long pdop, java.lang.Long hdop, java.lang.Long vdop, java.lang.Long measureCount) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: point = (src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point)value$; break;
   ...
   */
  public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point getPoint() {
    return point;
  }
   ...
   * @param value the value to set.
   */
  public void setPoint(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point value) {
    this.point = value;
  }
   ...
   */
  public static src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder newBuilder() {
    return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder();
  }
   ...
   * @return A new GPS RecordBuilder
   */
  public static src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder newBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder other) {
    if (other == null) {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder();
    } else {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder(other);
    }
  }
   ...
   * @return A new GPS RecordBuilder
   */
  public static src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder newBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS other) {
    if (other == null) {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder();
    } else {
      return new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GPS>
    ...
    private java.lang.CharSequence gpsDate;
    private src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point point;
    private src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point.Builder pointBuilder;
    private java.lang.Long pdop;
    private java.lang.Long hdop;
    private java.lang.Long vdop;
    private java.lang.Long measureCount;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder other) {
      super(other);
      ...
      if (other.hasPointBuilder()) {
        this.pointBuilder = src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point.newBuilder(other.getPointBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.gpsDate)) {
        this.gpsDate = data().deepCopy(fields()[0].schema(), other.gpsDate);
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setGpsDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder clearGpsDate() {
      gpsDate = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setPoint(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point value) {
     ...
     * @return This builder.
     */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point.Builder getPointBuilder() {
      if (pointBuilder == null) {
        if (hasPoint()) {
          setPointBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point.newBuilder(point));
        } else {
          setPointBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point.newBuilder());
        }
      }
      return pointBuilder;
    }
    ...
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setPointBuilder(src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point.Builder value) {
      clearPoint();
      pointBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder clearPoint() {
      point = null;
      pointBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setPdop(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder clearPdop() {
      pdop = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setHdop(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder clearHdop() {
      hdop = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setVdop(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder clearVdop() {
      vdop = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder setMeasureCount(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.GPS.Builder clearMeasureCount() {
      measureCount = null;
    ...
    public GPS build() {
      try {
        ...
        if (pointBuilder != null) {
          ...
          record.point = fieldSetFlags()[1] ? this.point : (src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point) defaultValue(fields()[1]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.point == null) {
          this.point = new src.main.java.zdf.learn.com.commonUtils.data.avro.schema.can300.Point();
        }
