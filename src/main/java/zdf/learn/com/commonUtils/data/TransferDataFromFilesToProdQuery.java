...
public class TransferDataFromFilesToProdQuery {
	...
	public void insertToProd() {
		BatchComputer batchCom = new BatchComputer(72,6);
		batchCom.startCompute();
		File allFiles = new File("/home/apuser/data");
...
//				"root", 
//				"3bQqPo4kEL");
		JdbcEnegine jdbc = new JdbcEnegine("jdbc:mysql://172.31.63.131:3306/gzhcrdb?useUnicode=true&characterEncoding=utf8&useSSL=false",
		"root", 
		"XkFhifQe7M");
