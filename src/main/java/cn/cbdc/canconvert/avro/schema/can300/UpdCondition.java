...
public class UpdCondition extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7747564141268803347L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UpdCondition\",\"namespace\":\"cn.cbdc.canconvert.avro.schema.can300\",\"fields\":[{\"name\":\"updConditionId\",\"type\":[\"null\",\"long\"],\"default\":null}],\"default\":null}");
   ...
   */
  public static cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder newBuilder() {
    return new cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder();
  }
   ...
   * @return A new UpdCondition RecordBuilder
   */
  public static cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder newBuilder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder other) {
    return new cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder(other);
  }
   ...
   * @return A new UpdCondition RecordBuilder
   */
  public static cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder newBuilder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition other) {
    return new cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UpdCondition>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.updConditionId)) {
        this.updConditionId = data().deepCopy(fields()[0].schema(), other.updConditionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder setUpdConditionId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder clearUpdConditionId() {
      updConditionId = null;
