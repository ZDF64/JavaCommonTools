...
public class Dcm19Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public cn.cbdc.canconvert.avro.schema.can300.CommonHeader commonHeader;
  @Deprecated public cn.cbdc.canconvert.avro.schema.can300.UpdCondition updCondition;
  @Deprecated public cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader vehicleInformationHeader;
  @Deprecated public java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity> dataCapacityList;
   ...
   */
  public Dcm19Message(cn.cbdc.canconvert.avro.schema.can300.CommonHeader commonHeader, cn.cbdc.canconvert.avro.schema.can300.UpdCondition updCondition, cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader vehicleInformationHeader, java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity> dataCapacityList) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: commonHeader = (cn.cbdc.canconvert.avro.schema.can300.CommonHeader)value$; break;
    case 1: updCondition = (cn.cbdc.canconvert.avro.schema.can300.UpdCondition)value$; break;
    case 2: vehicleInformationHeader = (cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader)value$; break;
    case 3: dataCapacityList = (java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public cn.cbdc.canconvert.avro.schema.can300.CommonHeader getCommonHeader() {
    return commonHeader;
  }
   ...
   */
  public void setCommonHeader(cn.cbdc.canconvert.avro.schema.can300.CommonHeader value) {
   ...
   */
  public cn.cbdc.canconvert.avro.schema.can300.UpdCondition getUpdCondition() {
    return updCondition;
  }
   ...
   * @param value the value to set.
   */
  public void setUpdCondition(cn.cbdc.canconvert.avro.schema.can300.UpdCondition value) {
   ...
   */
  public cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader getVehicleInformationHeader() {
   ...
   * @param value the value to set.
   */
  public void setVehicleInformationHeader(cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader value) {
   ...
   */
  public java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity> getDataCapacityList() {
   ...
   * @param value the value to set.
   */
  public void setDataCapacityList(java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity> value) {
   ...
   */
  public static cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder newBuilder() {
    return new cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder();
  }
   ...
   * @return A new Dcm19Message RecordBuilder
   */
  public static cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder newBuilder(cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder other) {
    return new cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder(other);
  }
   ...
   * @return A new Dcm19Message RecordBuilder
   */
  public static cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder newBuilder(cn.cbdc.canconvert.avro.schema.can300.Dcm19Message other) {
    return new cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Dcm19Message>
    ...
    private cn.cbdc.canconvert.avro.schema.can300.CommonHeader commonHeader;
    private cn.cbdc.canconvert.avro.schema.can300.CommonHeader.Builder commonHeaderBuilder;
    private cn.cbdc.canconvert.avro.schema.can300.UpdCondition updCondition;
    private cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder updConditionBuilder;
    private cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader vehicleInformationHeader;
    private cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader.Builder vehicleInformationHeaderBuilder;
    private java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity> dataCapacityList;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder other) {
      super(other);
      ...
      if (other.hasCommonHeaderBuilder()) {
        this.commonHeaderBuilder = cn.cbdc.canconvert.avro.schema.can300.CommonHeader.newBuilder(other.getCommonHeaderBuilder());
      }
      ...
      if (other.hasUpdConditionBuilder()) {
        this.updConditionBuilder = cn.cbdc.canconvert.avro.schema.can300.UpdCondition.newBuilder(other.getUpdConditionBuilder());
      }
      ...
      if (other.hasVehicleInformationHeaderBuilder()) {
        this.vehicleInformationHeaderBuilder = cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader.newBuilder(other.getVehicleInformationHeaderBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cn.cbdc.canconvert.avro.schema.can300.Dcm19Message other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.commonHeader)) {
        this.commonHeader = data().deepCopy(fields()[0].schema(), other.commonHeader);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setCommonHeader(cn.cbdc.canconvert.avro.schema.can300.CommonHeader value) {
     ...
     * @return This builder.
     */
    public cn.cbdc.canconvert.avro.schema.can300.CommonHeader.Builder getCommonHeaderBuilder() {
      if (commonHeaderBuilder == null) {
        if (hasCommonHeader()) {
          setCommonHeaderBuilder(cn.cbdc.canconvert.avro.schema.can300.CommonHeader.newBuilder(commonHeader));
        } else {
          setCommonHeaderBuilder(cn.cbdc.canconvert.avro.schema.can300.CommonHeader.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setCommonHeaderBuilder(cn.cbdc.canconvert.avro.schema.can300.CommonHeader.Builder value) {
      clearCommonHeader();
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder clearCommonHeader() {
      commonHeader = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setUpdCondition(cn.cbdc.canconvert.avro.schema.can300.UpdCondition value) {
     ...
     * @return This builder.
     */
    public cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder getUpdConditionBuilder() {
      if (updConditionBuilder == null) {
        if (hasUpdCondition()) {
          setUpdConditionBuilder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition.newBuilder(updCondition));
        } else {
          setUpdConditionBuilder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setUpdConditionBuilder(cn.cbdc.canconvert.avro.schema.can300.UpdCondition.Builder value) {
      clearUpdCondition();
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder clearUpdCondition() {
      updCondition = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setVehicleInformationHeader(cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader value) {
     ...
     * @return This builder.
     */
    public cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader.Builder getVehicleInformationHeaderBuilder() {
      if (vehicleInformationHeaderBuilder == null) {
        if (hasVehicleInformationHeader()) {
          setVehicleInformationHeaderBuilder(cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader.newBuilder(vehicleInformationHeader));
        } else {
          setVehicleInformationHeaderBuilder(cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setVehicleInformationHeaderBuilder(cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder clearVehicleInformationHeader() {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder setDataCapacityList(java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cn.cbdc.canconvert.avro.schema.can300.Dcm19Message.Builder clearDataCapacityList() {
    ...
    public Dcm19Message build() {
      try {
        ...
        if (commonHeaderBuilder != null) {
          ...
          record.commonHeader = fieldSetFlags()[0] ? this.commonHeader : (cn.cbdc.canconvert.avro.schema.can300.CommonHeader) defaultValue(fields()[0]);
        }
        if (updConditionBuilder != null) {
          record.updCondition = this.updConditionBuilder.build();
        } else {
          record.updCondition = fieldSetFlags()[1] ? this.updCondition : (cn.cbdc.canconvert.avro.schema.can300.UpdCondition) defaultValue(fields()[1]);
        }
        if (vehicleInformationHeaderBuilder != null) {
          record.vehicleInformationHeader = this.vehicleInformationHeaderBuilder.build();
        } else {
          record.vehicleInformationHeader = fieldSetFlags()[2] ? this.vehicleInformationHeader : (cn.cbdc.canconvert.avro.schema.can300.VehicleInformationHeader) defaultValue(fields()[2]);
        }
        record.dataCapacityList = fieldSetFlags()[3] ? this.dataCapacityList : (java.util.List<cn.cbdc.canconvert.avro.schema.can300.DataCapacity>) defaultValue(fields()[3]);
        return record;
